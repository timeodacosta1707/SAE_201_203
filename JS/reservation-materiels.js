...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const categorieFilter = document.getElementById('filtreCategorie');
    const items = document.querySelectorAll('.material-item');

    function filterItems() {
        const searchTerm = searchInput.value.toLowerCase();
        const selectedCategorie = categorieFilter.value.toLowerCase();
        ...
        items.forEach(item => {
            ...
            const matchesCategorie = selectedCategorie === '' || type === selectedCategorie;
    ...
    categorieFilter.addEventListener('change', filterItems);
    ...
    document.querySelectorAll('.btn-reserve').forEach(button => {
        button.addEventListener('click', function() {
            ...
            document.getElementById('materielNom').textContent = name;
        });
    });
});
