				...
				<div class="d-flex align-items-center d-lg-none justify-content-end mt-3">
					<div class="dropdown">
						...
						<ul class="dropdown-menu dropdown-menu-end">
							...
							<li>
								<a class="dropdown-item" href="./se_deconnecter.php">
									<i class="fas fa-sign-out-alt"></i> <spa>Se déconnecter</span>
								</a>
							</li>
						</ul>
					</div>
			...
			<div class="row g-4 mt-3">
				<div class="col-md-3">
					<div class="process-step text-center">
						...
						<h4>Choisissez</h4>
						<p>Sélectionnez le type de matériel ou la salle dont vous avez besoin</p>
					</div>
				</div>
				...
				<div class="col-md-3">
					<div class="process-step text-center">
						...
						<h4>Récupérez</h4>
						<p>Récupérez votre matériel ou accédez à votre salle à la date prévue</p>
					</div>
				</div>
			</div>
		</div>
