		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarContent">
				<ul class="navbar-nav mx-auto mb-2 mb-lg-0">
					...
					<li class="nav-item">
						<a class="nav-link active" href="./reserver.php">Réservations</a>
					</li>
					<li class="nav-item">
				...
				<div class="dropdown">
					<div class="icone-profil" data-bs-toggle="dropdown" aria-expanded="false">
						...
						<ul class="dropdown-menu dropdown-menu-end">
							...
							<li>
								<a class="dropdown-item" href="./se_deconnecter.php">
				...
				<div class="col-md-6">
					<div class="card h-100 option-card">
						<div class="card-body text-center p-5">
							...
							<a href="#" class="btn bg-couliut btn-lg rounded-pill px-4 custom-hover">Réserver du matériel</a>
						</div>
					</div>
				</div>
				...
				<div class="col-md-6">
					<div class="card h-100 option-card">
						<div class="card-body text-center p-5">
							...
							<a href="#" class="btn bg-couliut btn-lg rounded-pill px-4 custom-hover">Réserver une salle</a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="contenu-pied-page">
				...
				<div class="colonne-footer">
					...
					<ul class="list-unstyled">
						...
						<li><a href="./reserver.php">Réservations</a></li>
