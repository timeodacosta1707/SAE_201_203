<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        header("Location: envoyer_code.php");
        exit();
    }
?>
...
<body>
    ...
    <div class="email">
        ...
        <?php if (isset($_GET['erreur'])): ?>
            ...
            ?>
        <?php endif; ?>
        <p>Veuillez saisir votre adresse courriel ci-dessous et nous vous enverrons un courriel pour changer votre mot de passe. Vous avez fait une erreur ? <a id="retour_form" href="../index.php">Retourner à la page de connexion</a>.</p>
        <form method="POST" action="envoyer_code.php">
