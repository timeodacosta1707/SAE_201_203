...
$sqlTypes = "SELECT DISTINCT Type_materiel FROM Materiel WHERE Type_materiel IS NOT NULL AND Type_materiel != ''";
...
<head>
    ...
    <title>Université Gustave Eiffel - Réservation de Matériel</title>
...
<nav class="navbar navbar-expand-lg fixed-top">
	...
	<section class="banniere">
		<div class="container">
			...
			<p>Caméras, micros et bien d'autres</p>
		</div>
	</section>
    <main class="container my-5">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    <div class="search-bar">
                        <input type="text" id="searchInput" class="form-control" placeholder="Rechercher du matériel...">
        ...
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4" id="listeMateriel">
            <?php
            ...
            if (count($materiels) > 0) {
                foreach ($materiels as $materiel) {
                    ...
                    $type = htmlspecialchars($materiel['type_materiel']);
                    $description = htmlspecialchars($materiel['description']);
                    $quantite = htmlspecialchars($materiel['quantite']);
                    $image = htmlspecialchars($materiel['image']);
                    ?>
                    <div class="col material-item" data-type="<?php echo $type; ?>" data-name="<?php echo $nom; ?>">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center mt-3">
                                    <span class="badge bg-light text-dark">
                                        <i class="fas fa-tag me-1"></i><?php echo $type; ?>
                                    </span>
                                    <span class="badge bg-light text-dark">
                                        <i class="fas fa-cubes me-1"></i>Qté: <?php echo $quantite; ?>
                                    </span>
                                </div>
                            </div>
                            <div class="card-footer">
                                <a href="reservation_form.php?type=materiel&id=<?php echo $id; ?>&name=<?php echo urlencode($nom); ?>" class="btn btn-reserve w-100">
                ...
                echo '<div class="col-12 text-center"><p>Aucun matériel disponible</p></div>';
            }
            ?>
        </div>
    ...
    <script src="../../JS/reservation-materiels.js"></script>
    <script>
        // Chargement du script de réservation de matériels
        document.addEventListener('DOMContentLoaded', function() {
            // Le script est chargé dans le head de la page
        });
    </script>
